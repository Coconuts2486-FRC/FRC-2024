...
/**
 * Represents a module of a robot, which consists of a direction motor, drive motor, encoder, and PID controllers.
 */
public class Module {
  ...
  /**
   * Disables the module by setting the neutral mode to coast for both the direction and drive motors.
   * */
  public void disable() {
  ...
  /**
   * Enables the module by setting the neutral mode to brake for both the direction and drive motors.
   * */
  ...
  /**
   * Initializes the module for autonomous by setting the angle controller to continuous input and
