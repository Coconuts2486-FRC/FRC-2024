...
public static Joystick driver = new Joystick(0);
    ...
    public static int encoderFR = 11;//10
    public static int encoderFL = 10;//11
    public static int encoderBR = 13;//12
    public static int encoderBL = 12;//13
    ...
    public static int driveFR = 3;//2
    public static int driveFL = 2;//3
    public static int driveBR = 5;//4
    public static int driveBL = 4;//5

    public static int rotateFR = 7;//6
    public static int rotateFL = 6;//7
    public static int rotateBR = 9;//8
    public static int rotateBL = 8;//9
