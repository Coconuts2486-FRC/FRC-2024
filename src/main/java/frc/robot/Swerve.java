...
public class Swerve {
  ...
  /**
   * Reinitializes the swerve drive by resetting the gyro yaw, and setting the module angles to 0.
   * @param reinit true if the swerve drive should be reinitialized, false otherwise
   */
  ...
  /**
   * Disables the swerve drive by setting the neutral mode to coast for all the modules.
   */
