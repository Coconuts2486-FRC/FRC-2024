...
public class IntakeRollersIOReal implements IntakeRollersIO {
 ...
 @Override
  public void setRollerDutyCycle( double staticPercentTop,double staticPercentBottom,double manualIn,double manualOut,boolean lightStop) {// System.out.println(lightStop);
    if (lightStop == false) {
