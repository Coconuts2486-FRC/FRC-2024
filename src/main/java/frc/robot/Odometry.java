...
/**
 * This class represents the odometry of the robot.
 * It provides methods to calculate the position of the robot.
 */
public class Odometry {
  ...
  /**
   * This method calculates the position of the robot.
  ...
  public double[] calculatePosition() {
    ...
    x0 =
      x *
      Math.cos(swerve.getRobotAngle()) -
      y *
      Math.sin(swerve.getRobotAngle());
    y0 =
      y *
      Math.cos(swerve.getRobotAngle()) +
      x *
